...
/* package primerClase-0.1.0.0 */
#ifndef VERSION_primerClase
#define VERSION_primerClase "0.1.0.0"
#endif /* VERSION_primerClase */
#ifndef MIN_VERSION_primerClase
#define MIN_VERSION_primerClase(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_primerClase */
...
#define CURRENT_COMPONENT_ID "primerClase-0.1.0.0-CnRkkz1n0leFYc6uZZvffL-primerClase"
